          ...
          : (type === 'od')
            ? {
              ...
              conditions33: [
                ...
                'ผู้ให้สินเชื่อสามารถหักค่าธรรมเนียมในอัตราร้อยละ 0.5 ก่อนการรับสินเชื่อในแต่ละคราว โดยไม่ต้องแจ้งให้ผู้กู้ทราบล่วงหน้า และ/หรือ ผู้กู้สามารถชำระโดยตรงแก่ผู้ให้สินเชื่อ ในกรณีผู้ให้สินเชื่อเรียกให้ชำระก็ได้ ตามสัดส่วนที่ระบุในข้อ 1.2 ของสัญญาฉบับนี้'
              ]
            }
            : {}
    };
