      ...
      <div className="grid grid-cols-2 divide-x divide-black border border-black text-[13px]">
        ...
        <div className="p-8 flex flex-col min-h-[550px]">
          ...
          <div className="mt-12">
            ...
            <div className="flex items-end w-full max-w-[280px]">
              <span className="text-[14px] leading-none"></span>
              <div className="flex-1 border-b border-black mx-2 mb-1"></div>
              <span className="text-[14px] leading-none"></span>
            </div>
            <div className="text-center mt-2 w-full max-w-[280px] text-[12px]">
        ...
        <div className="p-8 flex flex-col min-h-[550px]">
          <div className="flex-1 space-y-12">
            ...
            <div className="mt-8 space-y-1 text-left px-0">
              <div className="font-bold whitespace-nowrap">ตำแหน่ง: {data.entityType === 'partnership' ? 'หุ้นส่วนผู้จัดการ' : 'กรรมการผู้มีอำนาจลงนาม'}</div>
              <div className="font-bold">
                <span className="bg-yellow-100 print:bg-transparent leading-relaxed rounded px-1">{data.customerCompany || '\u00A0'}</span>
              </div>
            </div>
