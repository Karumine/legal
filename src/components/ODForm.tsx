...
export default function ODForm({ data, onChange, agreements = [], currentAgreementId, onFocusSection, companyMode }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-white p-4 rounded-lg shadow-sm border border-blue-200" onFocusCapture={() => onFocusSection?.('od-conditions-extra-2')}>
        <div className="flex items-center gap-2 mb-3">
          <div className="w-2 h-2 rounded-full bg-blue-500"></div>
          <h3 className="font-semibold text-lg text-blue-700">เงื่อนไขบังคับเพิ่มเติมก่อนการเบิกใช้สินเชื่อ (ข้อ 3.3)</h3>
        </div>
