  ...
  return (
    <div className="text-gray-900 font-sans leading-[1.8] text-[13px] text-justify tracking-normal whitespace-pre-line">
      ...
      <div className="print-page relative">
        ...
        <div className="mb-4 pl-12 -indent-10 flex gap-2">
          <span>(1)</span>
        ...
        <div className="mb-6 pl-12 -indent-10 flex gap-2">
          <span>(2)</span>
          <div className="flex-1">
        ...
        <div className="indent-10 mb-6 flex gap-2">
          <div className="flex-1">
        ...
        <div className="mb-6 pl-12 -indent-10 flex gap-2">
          <span>(3)</span>
          <div className="flex-1">
            <b><Highlight>{data.guarantorName}</Highlight></b> ผู้ถือบัตรประจำตัวประชาชนเลขที่ <Highlight>{data.guarantorIdCard}</Highlight> มีที่อยู่ตามทะเบียนบ้านเลขที่ <Highlight>{data.guarantorAddress}</Highlight> (<b>"ผู้ค้ำประกัน"</b>) อีกฝ่ายหนึ่ง
          </div>
        </div>
        ...
        <div className="mb-4 pl-10 flex">
          <span className="w-12 shrink-0">1.</span>
          <div className="flex-1">
      ...
      <div className="print-page relative mt-8 print:mt-0">
        ...
        <div className="mt-8">
           ...
           <div className="mb-4 pl-8 -indent-8 flex gap-2">
             <span>3.</span>
             <div className="flex-1">
               สัญญาฉบับนี้มีผลบังคับใช้ตั้งแต่วันที่สัญญาค้ำประกันมีผลบังคับจนกว่าหนี้ใดๆ และทั้งปวงซึ่งผู้เช่าซื้อมีอยู่กับผู้ให้เช่าซื้อภายใต้สัญญาเช่าซื้อจะได้มีการชำระจนครบถ้วนหรือเมื่อหนี้ทั้งหมดภายใต้สัญญาดังกล่าวได้ระงับไป
             </div>
           </div>
           ...
           <div className="mb-4 pl-8 -indent-8 flex gap-2">
             ...
             <div className="flex-1">
               ...
               <div className="mt-1 pl-6 flex gap-2">
                 <span>ก.</span>
                 <div className="flex-1">
                   ผู้ค้ำประกันตกลงเข้าผูกพันตนรับผิดต่อผู้ให้เช่าซื้อในหนี้ของผู้เช่าซื้ออย่างลูกหนี้ร่วม
                 </div>
               </div>
               <div className="mt-1 pl-6 flex gap-2">
                 <span>ข.</span>
                 <div className="flex-1">
                   ผู้ค้ำประกันตกลงสละข้อต่อสู้ตามที่กำหนดไว้ในมาตรา 688, 689 และ 690 แห่งประมวลกฎหมายแพ่งและ พาณิชย์เป็นการเพิ่มเติมนอกเหนือจากการตกลงสละข้อต่อสู้ตามข้อ 4 ของสัญญานี้
                 </div>
               </div>
             </div>
           </div>
